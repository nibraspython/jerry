...
@Client.on_message(filters.incoming & ~filters.private & filters.command('ykick') & filters.user(ADMINS))
...
@Client.on_message(filters.incoming & ~filters.private & filters.command('nkick') & filters.user(ADMINS))
